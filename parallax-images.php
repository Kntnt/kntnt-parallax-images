 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Kntnt's Parallax Images plugin
 * Plugin URI:        https://www.kntnt.com/
 * Description:       Adds parallax behaviour to imagews that match a configurable CSS- or jQuery selector.
 * Version:           1.0.0
 * Author:            Thomas Barregren
 * Author URI:        https://www.kntnt.com/
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       kntnt-parallax-bases
...
(new Kntnt_Parallax_Images())->run();

// Plugin main class.
class Kntnt_Parallax_Images {
